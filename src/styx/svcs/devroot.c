...
/****
 * NOTE: Currently devroot uses a single root image that all kernel procs share.  This will 
 *       eventually be changed so that every hproc gets it's own root image.
 */
static Chan*
