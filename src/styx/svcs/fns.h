...
extern hproc_t* kern_baseproc(void (*start_func)(void *arg), char *start_module);
void	baseinit(hproc_t*);
...
void    os_spinlock(Lock*);
void    os_spinunlock(Lock*);
...
void		seterror(proc_t*, char*, ...);
void		setid(char*, int);
void	setpointer(int, int);
char*	skipslash(char*);
void		srvrtinit(void);
//void		swiproc(proc_t*, int);
...
void    ifree(void *);
void*   imalloc(size_t);
void*   irealloc(void *, size_t);
void*   icalloc(size_t, size_t);
...
hproc_t* new_hproc(uv_loop_t*);
vproc_t* new_vproc(proc_t*, int);

void progexit(vproc_t*);

void host_init();
void restore();
void stopsigs();
void drain_events(hproc_t*);

void setwatchers(void);
void dispatch(uv_prepare_t*);
